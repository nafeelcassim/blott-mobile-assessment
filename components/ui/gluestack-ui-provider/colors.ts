...
export const config = {
  ...
  dark: vars({
    "--color-primary-0": hexToRgba("#A6A6A6")!,
    "--color-primary-50": hexToRgba("#AFAFAF")!,
    "--color-primary-100": hexToRgba("#BABABA")!,
    "--color-primary-200": hexToRgba("#C5C5C5")!,
    "--color-primary-300": hexToRgba("#D4D4D4")!,
    "--color-primary-400": hexToRgba("#DDDDDD")!,
    "--color-primary-500": hexToRgba("#E6E6E6")!,
    "--color-primary-600": hexToRgba("#F0F0F0")!,
    "--color-primary-700": hexToRgba("#F0F0F0 ")!,
    "--color-primary-800": hexToRgba("#FDFDFD")!,
    "--color-primary-900": hexToRgba("#FEF9F9")!,
    "--color-primary-950": hexToRgba("#FDFCFC")!,
